        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-secondary-600 mb-8">
              ...
              Our team of experts is ready to help you find the perfect solar solution for your needs.
            </p>
            
            <div className="bg-secondary-50 rounded-lg p-6 mb-8">
              <h3 className="text-xl font-semibold text-secondary-900 mb-4">Why Contact Us?</h3>
